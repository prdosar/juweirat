...
import { CheckCircle, User, Mail, Phone, Globe, CreditCard, Smartphone, Lock, ChevronRight, CalendarDays, Users, MapPin, ArrowLeft } from 'lucide-react'
...
export default function BookingForm({ room, lang, checkIn: initCheckIn, checkOut: initCheckOut, adults, children }: Props) {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
        ...
        <p className="text-charcoal/40 text-sm font-light max-w-md mb-8">
          {fr
            ? "Notre équipe vous contactera dans les plus brefs délais pour confirmer votre séjour."
        ...
        <div className="bg-white border border-charcoal/10 p-6 text-left w-full max-w-md space-y-3 shadow-sm">
          <div className="flex items-center justify-between border-b border-charcoal/10 pb-3">
            <span className="text-charcoal font-semibold text-sm">{name}</span>
      ...
      <div className="lg:col-span-3 space-y-8">
        ...
        {step === 1 && (
          <div className="space-y-6">
            ...
            {/* Dates (editable with dynamic live recalculation) */}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-surface border border-charcoal/10 text-charcoal px-4 py-2.5 text-sm font-light
                           focus:outline-none focus:border-green transition-colors resize-none placeholder:text-charcoal/20"
              />
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3.5 bg-green text-charcoal text-xs tracking-widest uppercase font-semibold
                         hover:bg-green-light transition-colors duration-300 disabled:opacity-30 disabled:cursor-not-allowed group shadow-sm"
            >
        ...
        {/* ── STEP 2 : Payment method + Return to Step 1 ── */}
        {step === 2 && (
          <div className="space-y-6">
        ...
        <div className="sticky top-28 space-y-4">
          ...
          <div className="bg-white border border-charcoal/10 overflow-hidden shadow-sm">
            ...
            <div className="p-5">
              ...
              <p className="text-charcoal/40 text-xs font-light flex items-center gap-1">
                <MapPin size={11} className="text-green" /> Résidence Juweirat · Lomé, Togo
              </p>
            </div>
          </div>

          {/* Stay details (Reactive to date changes in real time) */}
          <div className="bg-white border border-charcoal/10 p-5 space-y-4 shadow-sm">
            ...
            {/* Price breakdown (Dynamic Live Calculation) — les tarifs stockés
                sont HT, la TVA 18% est ajoutée par-dessus pour donner le TTC. */}
            <div className="space-y-2.5">
              <div className="flex justify-between text-sm">
                <span className="text-charcoal/60 font-light">
                  {formatFCFAHT(room.tarifNuit)} × {localNights} {fr ? (localNights > 1 ? 'nuits' : 'nuit') : (localNights > 1 ? 'nights' : 'night')}
                </span>
